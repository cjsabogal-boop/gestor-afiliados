  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          <h1 className="text-3xl font-black text-white tracking-tight">Votaciones</h1>
          <p className="text-white/40 text-sm mt-1">Lanzamiento de encuestas y votaciones con registro de opciones en blockchain opcional.</p>
        </div>
      ...
      <div className="bg-white/5 border border-white/10 rounded-2xl p-6 h-[500px] flex items-center justify-center text-white/30 font-mono text-sm">
        [Módulo de Votaciones en Construcción]
      </div>
    </div>
  );
}
