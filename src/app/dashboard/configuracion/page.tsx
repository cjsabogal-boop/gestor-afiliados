  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          <h1 className="text-3xl font-black text-white tracking-tight">Configuración de Comunidad</h1>
          <p className="text-white/40 text-sm mt-1">Ajustes generales, integraciones, roles de administrador y preferencias.</p>
        </div>
